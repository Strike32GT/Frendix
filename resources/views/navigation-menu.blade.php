<nav x-data="{ open: false }" class="text-black shadow" style="background-color: #D9D9D9">
            ...
            <div class="flex">
                ...
                <div class="flex items-center justify-center flex-grow px-4">
                    <input
                        type="text"
                        placeholder="Buscar..."
                        class="w-full max-w-md px-4 py-2 rounded-md bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        >
                </div>        
                <!-- Logo -->
